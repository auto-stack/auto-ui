...
use crate::style::theme::ActiveTheme as _;
use crate::style::color;
use crate::event::InteractiveElementExt as _;
use crate::style::size::Sizer;
...
impl TextInput {
    ...
    /// Set the Input size
    pub fn set_size(&mut self, size: SizeScale, cx: &mut ViewContext<Self>) {
        self.size = size;
        cx.notify();
    }
    ...
    fn select_word(&mut self, offset: usize, cx: &mut ViewContext<Self>) {
        ...
        let mut end = start;
        let prev_text = self.text_for_range(0..start, &mut None, cx).unwrap_or_default();
        let next_text = self
...
impl TextInput {
    fn with_size(mut self, size: impl Into<SizeScale>) -> Self {
        self.size = size.into();
        self
    }
}
    ...
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .when(self.appearance, |this| {
                ...
                .when(suffix.is_none(), |this| this.pr_for(self.size))
            })
            .children(prefix)
            .gap_1()
            .items_center()
